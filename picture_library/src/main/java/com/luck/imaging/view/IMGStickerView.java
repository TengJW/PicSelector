...
import com.luck.imaging.core.sticker.IMGSticker;
import com.luck.imaging.core.sticker.IMGStickerAdjustHelper;
import com.luck.imaging.core.sticker.IMGStickerHelper;
import com.luck.imaging.core.sticker.IMGStickerMoveHelper;
import com.luck.picture.lib.R;

import static com.luck.imaging.IMGEditActivity.EXTRA_IMAGE_WATERMARK;
...
public abstract class IMGStickerView extends ViewGroup implements IMGSticker, View.OnClickListener {
    ...
    @Override
    public boolean show() {
        boolean ishow = mStickerHelper.show();
        Intent intent = new Intent();
        intent.setAction(EXTRA_IMAGE_WATERMARK);
        intent.putExtra("isAddWaterMark", ishow);
