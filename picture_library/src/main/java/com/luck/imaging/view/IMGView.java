...
import com.luck.imaging.core.IMGImage;
import com.luck.imaging.core.IMGMode;
import com.luck.imaging.core.IMGPath;
import com.luck.imaging.core.IMGText;
import com.luck.imaging.core.anim.IMGHomingAnimator;
import com.luck.imaging.core.homing.IMGHoming;
import com.luck.imaging.core.sticker.IMGSticker;
import com.luck.imaging.core.sticker.IMGStickerPortrait;
...
public class IMGView extends FrameLayout implements Runnable, ScaleGestureDetector.OnScaleGestureListener,
    ...
    public void addWaterMark(IMGText text) {
...
//
//        int marginbootom = (int) ((windowHeight - mImage.getClipFrame().bottom));
